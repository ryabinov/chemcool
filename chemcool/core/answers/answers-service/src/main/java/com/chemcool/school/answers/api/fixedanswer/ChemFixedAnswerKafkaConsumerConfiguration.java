...
public class ChemFixedAnswerKafkaConsumerConfiguration {
    ...
    public static final String TRUSTED_PACKAGES =  "com.chemcool.school.answers.tasks.chemfixedanswer.domain";
    ...
    public Map<String, Object> consumerConfig(){
        ...
        prop.put(ConsumerConfig.GROUP_ID_CONFIG, kafkaProperties.getGroupId1());
        return prop;
    }
