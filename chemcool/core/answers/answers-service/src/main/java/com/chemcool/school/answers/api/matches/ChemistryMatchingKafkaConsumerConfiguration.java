...
public class ChemistryMatchingKafkaConsumerConfiguration {
    ...
    public static final String TRUSTED_PACKAGES =  "com.chemcool.school.answers.tasks.chemmatches.domain";
    ...
    public Map<String, Object> consumerConfig() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, this.kafkaProperties.getGroupId2());
        return properties;
    }
